...
const sumaDeDosNumeros = () => {
  ...
  alert15(
    `La suma es:  ${numero1} + ${numero2} = ${numero1 + numero2}`,
    "warning"
  );
  alert15(
    `La resta es: ${numero1} - ${numero2} = ${numero1 - numero2}`,
    "danger"
  );
};
...
const multiDivision = () => {
  ...
  alert16(
    `La Multiplicación de  ${numero16} * ${numero162} = ${
      numero16 * numero162
    }`,
    "info"
  );
  alert16(
    `La División de ${numero16} / ${numero162} = ${numero16 / numero162}`,
    "danger"
  );
};
